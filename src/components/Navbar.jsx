  ...
  return (
    <header className="header">
      ...
      <nav className="navigation">
        ...
        <Link className={`${currentRouter !== pathname.home ? `${currentRouter === pathname.tourPlan ? "text-white" : "text-gray-500"}` : "text-white"} py-1.5 px-4 rounded-full mx-2 font-medium hover:bg-[#359381] hover:text-white ${currentRouter === pathname.tourPlan && "bg-[#359381]"} active:text-white`} href={pathname.tourPlan}>Tour Plan</Link>
